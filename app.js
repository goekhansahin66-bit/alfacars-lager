...
(function initSupabase() {
  ...
  const url = "https://vocuyvgkbswoevikbbxa.supabase.co";
...
renderBrands();
switchView("orders");// ===============================
// TEST: Daten aus Supabase lesen
// ===============================
async function testLoadFromSupabase() {
  if (!supabaseClient) {
    console.warn("❌ Supabase Client nicht bereit");
    return;
  }
  ...
  if (error) {
    ...
    console.log("📦 Supabase Daten (orders):", data);
  }
}

// Test einmal ausführen
testLoadFromSupabase();
