...
/* =========================================================
   STORAGE & KONSTANTEN
   ========================================================= */
const STORAGE_KEY = "alfacars_orders_final"; // nur für EINMALIGE Migration (keine laufende Nutzung)
  ...
  orders.forEach((o,i)=>{
    ...
    card.oncontextmenu = e=>{
      ...
      if(confirm("Archiv-Eintrag endgültig löschen?")){
        const id = o.id;
        // FIX: stabil per ID löschen (Index kann durch Filter/Suche veraltet sein)
...
function openEditOrder(id){
  ...
  // FIX: Guard gegen veralteten Zustand (z.B. nach Sync/Filter)
  if (!o){
    alert("Bestellung nicht gefunden. Ich lade die Daten neu…");
