  ...
  orders.forEach((o,i)=>{
    ...
    card.oncontextmenu = e=>{
      ...
      if(confirm("Archiv-Eintrag endgültig löschen?")){
        const id = o.id;
        // ✅ FIX: nicht mehr über Array-Index löschen (kann veraltet sein),
        //         sondern stabil über die ID.
...
function openEditOrder(id){
  ...
  if (!o){
    // ✅ FIX: Schutz gegen "undefined" (z.B. wenn der lokale State veraltet ist)
    alert("Bestellung nicht gefunden. Daten werden neu geladen.");
