...
function mapOrderForDb(o){
  // FINAL FIX: Nur Spalten verwenden, die sicher existieren
...
async function initOrdersFromSupabase(){
  ...
  // 2) MIGRATION DEAKTIVIERT (VERCEL-SAFE)
  return;

  // 2) Einmalige Migration: Altbestand aus localStorage -> Supabase (DEAKTIVIERT)
...
async function initApp(){
  ...
  switchView("orders");
  } catch(e){ console.error('❌ Init crash prevented:', e); }
}
